    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="hidden md:block absolute inset-0 z-0">
          <Image
            src="/assets/background_milimati.png"
            alt="Background"
            fill
      ...
      {/* Countdown Section */}
      <section id="countdown-section" className="pt-0 pb-0 px-4 flex items-center justify-center relative" style={{ backgroundColor: '#BBAC91' }}>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mb-6">
                  <Image 
                    ...
                    width={150} 
                    height={150} 
                    style={{ filter: 'brightness(0) saturate(100%) invert(70%) sepia(15%) saturate(500%) hue-rotate(15deg) brightness(95%) contrast(85%)' }}
                    unoptimized 
                  />
                </div>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <a
              ...
              style={{ backgroundColor: '#d4c4a8', color: '#ffffff' }}
            >
              SUGERÍ TU TEMA ACÁ
            </a>
          </div>
      ...
      {/* Details Section */}
      <section className="py-16 md:py-20 px-4" style={{ backgroundColor: '#BBAC91' }}>
        <div className="max-w-4xl mx-auto">
          {/* Heading */}
          <div className="text-center mb-12 md:mb-16">
            <h2 className="font-playfair text-3xl md:text-4xl text-white italic leading-tight">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div>
              ...
              >
                <div className="flex-1">
                  <p className="font-montserrat text-lg md:text-xl text-white uppercase tracking-wide mb-2">
                ...
                <div className="ml-4">
                  ...
                  >
                    <path d="M4 2L8 6L4 10" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
              ...
              {/* Contenido Regalo */}
              {openSections.regalo && (
                <div className="mt-6 pl-4 border-l-2 border-white">
                  <h3 className="font-montserrat text-xl md:text-2xl text-white uppercase tracking-wide mb-4">
                    Datos Bancarios
                  </h3>
                  <div className="space-y-3 font-montserrat text-base md:text-lg text-white">
            ...
            <div>
              ...
              {openSections.hoteles && (
                <div className="mt-6 pl-4 border-l-2 border-white">
                  <h3 className="font-montserrat text-xl md:text-2xl text-white uppercase tracking-wide mb-6">
                    Hoteles
                  </h3>
                  <div className="space-y-8">
                    {/* Hotel 1 */}
                    <div>
                      <h4 className="font-montserrat text-lg md:text-xl text-white font-semibold mb-2">
                        Hotel El Creston II
                      </h4>
                      <p className="font-montserrat text-base md:text-lg text-white mb-3">
                        387154132844
                      </p>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-montserrat text-base md:text-lg text-white underline hover:opacity-80 transition-opacity"
                      >
                        Cómo llegar
                      </a>
                    </div>
      ...
      <section className="py-16 md:py-20 px-4" style={{ backgroundColor: '#BBAC91' }}>
        <div className="max-w-2xl mx-auto text-center">
          {/* Heading */}
          <h2 className="font-playfair text-3xl md:text-4xl text-white italic mb-8 leading-tight">
      ...
      <section className="relative pt-4 md:pt-4 pb-20 px-4 min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/assets/Banner-Web-Conf-Q21-BOHO-CHIC-RTI.webp"
            alt="Background"
            fill
            className="object-cover"
            priority
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center px-4">
          ...
          <div className="flex justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white px-8 py-4 rounded-full font-montserrat text-sm md:text-lg uppercase tracking-wide transition-opacity duration-200 hover:opacity-80 md:w-[350px] md:h-[50px] md:px-0 flex items-center justify-center"
              style={{ backgroundColor: '#d4c4a8' }}
            >
      ...
      {/* Footer */}
      <footer className="relative py-20 px-4 min-h-[200px] flex items-center justify-center" style={{ backgroundColor: '#BBAC91' }}>
        {/* Main Message */}
        <p className="font-playfair text-4xl md:text-5xl text-white italic">
          ¡Te esperamos!
        </p>
      </footer>
    </div>
